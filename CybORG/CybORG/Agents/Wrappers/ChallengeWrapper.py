...
class ChallengeWrapper(Env,BaseWrapper):
    def __init__(self, agent_name: str, env, agent=None, reward_threshold=None, max_steps=12):
    ...
    def reset(self):
        self.step_counter = 0
        #env = BlueTableWrapper(env=None, turns_per_game=self.turns_per_game, output_mode='vector')
