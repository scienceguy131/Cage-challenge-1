...
class CompetitiveWrapper(BaseWrapper):
    def __init__(self, turns, env=None, agent=None, output_mode="vector"):
        ...
        self.blue_action_list = blue_lone_actions + list(product(blue_host_actions, self.hostnames))
    ...
    def _create_red_vector(self):
        ...
        # three flags for each host:
        # h1 - has this host been scanned
        # h2/h3 - is there None, User, or Privileged access on this host
        ...
        for host in self.hostnames:
            if str(self.ip_map[host]) in self.red_info:
                ...
                if self.subnet_scan_status[0] == 0:
                    #print(self.red_info[host_ip][0])
                    #print(self.subnet_map["User"])
                ...
                # h2/h3 - is there user/root access on this host
