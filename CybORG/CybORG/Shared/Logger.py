...
class CybORGLogger:
    """A evals class for CybORG.

    It has two main functions:
    1. acts as a wrapper for the Python evals class
    ...
    def setup(config, verbosity: int = None):
        """Setup the CybORG evals using given configuration.
        ...
        verbosity : int, optional
            verbosity level of console evals, if None uses level in config.
        ...
        # set the log level of the evals itself
        logger.setLevel(console_log_level)

        # Do NOT propogate log messages to the root evals
        ...
        # note this is not the default evals name for SSHTunnel,
